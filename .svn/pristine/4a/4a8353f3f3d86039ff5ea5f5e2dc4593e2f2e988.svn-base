...
public class MyPageProgressView extends ImageView {
     ...
     * @param defStyle
     */
    public MyPageProgressView(Context context, AttributeSet attrs, int defStyle) {
     ...
     * @param attrs
     */
    public MyPageProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
     ...
     * @param context
     */
    public MyPageProgressView(Context context) {
        super(context);
        init(context);
    }
