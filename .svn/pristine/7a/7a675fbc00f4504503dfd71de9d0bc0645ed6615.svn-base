package com.gaoge.view.practise.bitmap.fun.test.provider;

import com.gaoge.view.practise.bitmap.fun.test.util.MyImageWorker.MyImageWorkerAdapter;
...
public class MyImages {
    ...
    /**
     * Simple static adapter to use for MyImages.
     */
    public final static MyImageWorkerAdapter imageWorkerUrlsAdapter = new MyImageWorkerAdapter() {
        @Override
        public Object getItem(int num) {
            return MyImages.imageUrls[num];
        }
     ...
     */
    public final static MyImageWorkerAdapter imageThumbWorkerUrlsAdapter = new MyImageWorkerAdapter() {
        @Override
        public Object getItem(int num) {
            return MyImages.imageThumbUrls[num];
        }
