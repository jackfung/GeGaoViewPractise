...
public class MyDataController {
    ...
    private static MyDataController sInstance;
    ...
    /* package */ static MyDataController getInstance(Context c) {
        if (sInstance == null) {
            sInstance = new MyDataController(c);
        }
        return sInstance;
    }

    private MyDataController(Context c) {
        ...
        private void doQueryBookmarkStatus(String url, Object replyTo) {
            ...
            try {
                cursor = mContext.getContentResolver().query(
                        MyBookmarkUtils.getBookmarksUri(mContext),
