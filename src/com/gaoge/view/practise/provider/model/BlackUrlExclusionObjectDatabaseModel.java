...
public class BlackUrlExclusionObjectDatabaseModel {

    public BlackExclusionObject createItem(Context context,String type, String url
            ,  String host){
        if (context == null || url == null) {
            return null;
        }

        BlackExclusionObject item = new BlackExclusionObject(context, type,url, host);
    ...
    public void deleteItem(Context context, String url) {
        ...
        Query query = new Query(BlackExclusionObject.class);

        ExpressionToken selToken =
                BlackExclusionObject.COLUMN_URL_PATTERN.eq(url);
        if (selToken != null) {
    ...
    public void updateItem(Context context,String type, String url
        ...
        BlackExclusionObject object = createItem(context, type,url, host);
     ...
     * @return
     */
    public BlackExclusionObject getItem(Context context, String url) {
        ...
        return (BlackExclusionObject) objects.get(0);
    }
}
